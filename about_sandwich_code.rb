...
class AboutSandwichCode < Neo::Koan
  ...
  def test_counting_lines2
    assert_equal file_sandwich("example_file.txt"){ |file| count_lines2(file) } , count_lines2("example_file.txt")
  end
  ...
  def find_line2(file_name)
    ...
    count = 0
    file_sandwich("example_file.txt"){ |file| while line = file.gets
      count += 1
      if line.match(/e/)        
        return count 
      end
  ...
  def test_finding_lines2
    assert_equal file_sandwich("example_file.txt"){ |file| count_lines2(file) } , find_line2("example_file.txt")
  end
  ...
  def test_open_handles_the_file_sandwich_when_given_a_block
    assert_equal file_sandwich("example_file.txt"){ |file| count_lines2(file) } , count_lines3("example_file.txt")
  end
